...
class UNet_model(object):
    ...
    def add_logits(self):
        ...
        self.conv3_1 = conv(self.pool2, 3, 3, 256, 1, 1, padding = 'SAME', name = 'conv3_1') # [~, w/4, h/4, 256]
        ...
        self.norm5 = norm_rescale(self.conv1_2, 64, 'norm5')  #[~, w, h, 64]
        self.concat5 = tf.concat([self.deconv5, self.norm5], axis=3) #[~, w, h, 128]
        self.conv10_1 = conv(self.concat5, 1, 1, self.no_of_classes, 1, 1, padding = 'SAME', non_linear="NONE", name='conv10_1')#[~, w, h, out_channels(<64)]
